        ...
        static void Main(string[] args)
        {
            AssetTemplate assetTemplate = new AssetTemplate()
            {
                ...
                Data = new AssetTemplateData()
                {
                    ...
                    AssetTags = new List<AssetTemplateAssetTagData>() { new AssetTemplateAssetTagData() { TagName = "Base Tag Name 1" }, new AssetTemplateAssetTagData() { TagName = "Base Tag Name 2" } }
                },
            };
